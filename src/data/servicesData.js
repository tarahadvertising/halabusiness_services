export const servicesData = [
  {
    ...
    shortDesc: "Long-term 10-year UAE self-sponsored residency for property investors (AED 2M+), senior executives, doctors, entrepreneurs, and scientists.",
    price: "Free Eligibility Check",
    featured: true,
    icon: "Crown",
    features: [
      "10-Year Self-Sponsored Residency",
      "Sponsor Family & Unlimited Domestic Staff",
      "Stay outside UAE over 6 months without cancellation",
      "Exclusive Esaad Privilege Discount Card"
    ],
    details: {
      overview: "The UAE 10-Year Golden Visa allows international investors, entrepreneurs, and exceptional talents to live, work, and study in Dubai without needing a national sponsor.",
      deliverables: [
        "10-Year Digital Residence Visa Stamped in Passport",
        "10-Year UAE Resident Identity Card (Emirates ID)",
        "VIP Medical Fitness Fast-Track Clearance",
        "Esaad Privilege Discount Card Activation",
        "Full Family Sponsorship File Setup"
      ],
      prerequisites: [
        "Real Estate: Title deed with property valuation >= AED 2,000,000",
        "Executives: Salary certificate >= AED 30,000/mo + attested university degree",
        "Specialists / Doctors: DHA / MOHAP / MOH license and accreditation letter",
        "Entrepreneurs: Audited business valuation and incubator approval"
      ],
  ...
  },
  {
    ...
    badge: "24h Express",
    badgeType: "fast",
    image: "/images/services/trade-license-renewal.jpg",
    shortDesc: "Seamless annual trade license renewals, partner amendments, activity additions, and DED compliance management without business disruption.",
    price: "Same Day Turnaround",
    featured: false,
    icon: "RefreshCw",
    features: [
      "24-Hour Express License Renewal",
      "Ejari Verification & Renewal Coordination",
      "DED Fee Optimization & Penalty Reductions",
      "Partner / Shareholder & Activity Amendments"
    ],
    details: {
      overview: "Avoid costly late penalties and blacklisting. Hala Business Service audits your company license, updates your tenancy registration (Ejari), and issues your renewed license.",
      deliverables: [
        "Renewed Commercial / Professional Trade License",
        "Updated Chamber of Commerce Membership",
        "Updated Establishment Immigration File",
        "Official Payment Voucher & Receipt"
      ],
      prerequisites: [
        "Current Trade License copy",
        "Valid Ejari Tenancy Certificate",
        "Passport copies of all active partners",
        "External approvals (if required by your activity)"
      ],
      timeline: "Same Day (Within 4 - 8 hours of submission)",
      governmentAuthority: "Dubai Economy & Tourism (DET) / DED"
    }
  },
  {
    id: "virtual-office",
  ...
  },
  {
    ...
    shortDesc: "Bring your loved ones to live in the UAE. Comprehensive sponsorship services for spouses, children, parents, and newborn baby visa registration.",
    price: "Complete Family PRO",
    featured: false,
    icon: "Users",
    features: [
      "Spouse & Children Sponsorship (Up to 25 Years for Sons)",
      "Parents 1-Year & Golden Visa Extended Sponsorship",
      "Newborn Baby Visa Registration & Emirates ID",
      "Marriage & Birth Certificate Legalization Support"
    ],
    details: {
      overview: "Reunite your family in Dubai smoothly. We handle salary criteria verification, document attestation, tenancy requirements, and visa issuance.",
      deliverables: [
        "Family Entry Permits & Status Change",
        "VIP Medical Fitness Appointment & Typing",
        "Emirates ID Cards for All Family Members",
        "Residence Visa Stamping"
      ],
      prerequisites: [
        "Sponsor Passport, Emirates ID, and valid Residence Visa",
        "Salary Certificate (Minimum AED 4,000 or AED 3,000 + accommodation)",
        "Attested Marriage Certificate (for spouse)",
        "Attested Birth Certificates (for children)",
        "Registered Ejari Tenancy Contract & DEWA Bill"
      ],
      timeline: "3 - 4 Working Days per family member",
      governmentAuthority: "GDRFA Dubai / Amer"
    }
  },
  {
    id: "insurance",
    ...
    shortDesc: "Mandatory UAE health insurance packages (Essential Benefits Plan & Comprehensive), corporate group medical coverage, and commercial liability.",
    price: "Starting AED 650/yr",
    featured: false,
    icon: "ShieldCheck",
    features: [
      "DHA & MOHAP Compliant Health Insurance Plans",
      "Investor, Employee & Dependent Basic & VIP Packages",
      "Commercial Property, Fleet & Public Liability Coverage",
      "Instant Policy Certificate Generation for Visa Stamping"
    ],
    details: {
      overview: "Health insurance is mandatory for all UAE residence visas and license renewals. We provide direct comparison and instant certificate issuance.",
      deliverables: [
        "Official Health Insurance Policy Certificate",
        "Digital Health Card on Mobile App",
        "Direct Billing Hospital & Pharmacy Network Access"
      ],
      prerequisites: [
        "Passport copy, Visa copy / Entry Permit",
        "Emirates ID copy (or application form)",
        "Digital passport-size photo"
      ],
      timeline: "Instant (Within 15 - 30 Minutes)",
      governmentAuthority: "Dubai Health Authority (DHA) & Central Bank of UAE"
    }
  },
  {
    ...
    badge: "Multi-Agency",
    badgeType: "primary",
    image: "/images/services/government-approval.jpg",
    shortDesc: "Specialized external approvals and NOCs from Dubai Municipality, RTA, Dubai Civil Defense, KHDA, Central Bank, and SIRA for regulated activities.",
    price: "Guaranteed Approvals",
    featured: false,
    icon: "Award",
    features: [
      "Dubai Municipality (DM) - Food, Cosmetics, Construction",
      "RTA Approvals for Transport, Rental & Logistics",
      "Dubai Civil Defense (DCD) Fire Safety Clearances",
      "SIRA (Security Industry Regulatory Agency) Licensing"
    ],
    details: {
      overview: "Regulated business activities in Dubai require special clearance before license issuance. Our specialized legal PRO team secures these NOCs rapidly.",
      deliverables: [
        "Official Government NOC / External Approval Certificate",
        "Technical Inspection Report & Compliance Clearance",
        "DED System Activity Activation"
      ],
      prerequisites: [
        "Initial approval from DED",
        "Proposed office/warehouse layout blueprint",
        "Trade license copy and technical qualifications"
      ],
      timeline: "2 - 5 Working Days depending on the authority",
      governmentAuthority: "DM, RTA, DCD, SIRA, KHDA, Central Bank"
    }
  },
  {
    id: "ded-services",
  ...
  },
  {
    ...
    badgeType: "vip",
    image: "/images/services/emirates-id-medical.jpg",
    shortDesc: "Express VIP medical fitness examinations (results in 2-4 hours), VIP biometric appointments for Emirates ID, and fast card delivery to your doorstep.",
    price: "VIP 2-Hour Results",
    featured: true,
    icon: "IdCard",
    features: [
      "VIP Medical Fitness Test with 2-Hour Results",
      "Queue-Free VIP Biometric Appointment Typing",
      "Direct Courier Card Delivery to Home or Office",
      "Instant Electronic Emirates ID QR Download"
    ],
    details: {
      overview: "Skip long lines at health centers and biometric booths. Our VIP service escorts you through express medical testing with certified results in 2 hours.",
      deliverables: [
        "Certified Fit Medical Fitness Certificate",
        "Stamped Biometrics Application Form",
        "Physical Plastic Emirates ID Card by Courier"
      ],
      prerequisites: [
        "Original Passport & Entry Permit / Visa copy",
        "Passport-size photo with white background",
        "Current UAE mobile number"
      ],
